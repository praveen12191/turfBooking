...
const GameSelection: React.FC<GameSelectionProps> = ({ games, onGameSelect, onBack }) => {
  return (
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Select Your Game</h1>
          </div>
        </div>
      </header>
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
              <div>
                <strong className="text-gray-900">Time Slots:</strong> 30-minute intervals
              </div>
              <div>
                <strong className="text-gray-900">Availability:</strong> 24/7 booking
              </div>
              <div>
                <strong className="text-gray-900">Cancellation:</strong> Up to 2 hours before
              </div>
            </div>
          </div>
        </div>
